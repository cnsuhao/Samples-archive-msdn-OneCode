...
<%@ Page Language="VB" AutoEventWireup="true" CodeBehind="TaskEditForm.aspx.vb" Inherits="VBSharePointAlertTask.Layouts.VBSharePointAlertTask.TaskEditForm" DynamicMasterPageFile="~masterurl/default.master" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" class="ms-propertysheet">
      ...
      <asp:PlaceHolder ID="PlaceHolder1" runat="server">                
        <asp:Button UseSubmitBehavior="false" runat="server" class="ms-ButtonHeightWidth" OnClick="btnCancel_Click" Text="Approve" id="btnApprove" /> &nbsp;
                          <asp:Button UseSubmitBehavior="false" runat="server" class="ms-ButtonHeightWidth" OnClick="btnReassign_Click" Text="Reassign" id="btnReassign"  /> &nbsp;
                                <asp:Button UseSubmitBehavior="false" runat="server" class="ms-ButtonHeightWidth" OnClick="btnCancelTask_Click" Text="CancelTask" id="btnCancelTask"  /> &nbsp;
        <asp:Button UseSubmitBehavior="false" runat="server" class="ms-ButtonHeightWidth" OnClick="btnCancel_Click" Text="CancelOperation" id="btnCancel"  />
      </asp:PlaceHolder>
      </template_buttons>
        </wssuc:ButtonSection>
    </table>

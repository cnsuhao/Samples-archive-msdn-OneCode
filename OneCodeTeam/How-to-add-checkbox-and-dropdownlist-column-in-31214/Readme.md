...
<h1><span lang="EN-US">Add checkbox to each row of MVC Web Grid (CSASPNETWebGrid)</span></h1>
<h2><span lang="EN-US">Introduction</span></h2>
<p class="MsoNormal"><span lang="EN-US">This sample will show how to add checkbox to MVC web grid. You can find the answers to the following questions in the code sample:</span></p>
...
</span></span></span><span lang="EN-US">How to extend WebGrid helper to support checkbox better?</span></p>
<p class="MsoListParagraphCxSpMiddle" style="text-indent:5.0pt"><span lang="EN-US" style="font-family:Symbol"><span>&bull;<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><span lang="EN-US">How to add checkbox to web grid? </span></p>
<p class="MsoListParagraphCxSpLast"><span lang="EN-US">&nbsp;</span></p>
<h2><span lang="EN-US">Running the Sample</span></h2>
<p class="MsoNormal"><span lang="EN-US">You can directly run this sample.</span></p>
<p class="MsoNormal"><span lang="EN-US">After you run the project, you can see the result like below:</span></p>
<p class="MsoNormal"><span lang="EN-US"><img src="/site/view/file/126566/1/image.png" alt="" width="1041" height="674" align="middle">
</span></p>
<h2><span lang="EN-US">Using the Code</span></h2>
<p class="MsoNormal"><span lang="EN-US">The code sample provides the following reusable functions for WebGrid.</span></p>
<h3><span lang="EN-US">How to extend WebGrid helper to support checkbox better</span></h3>
<p><span lang="EN-US"></p>

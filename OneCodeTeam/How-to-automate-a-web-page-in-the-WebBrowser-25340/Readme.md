...
<h1>How to Automate HTML Elements Loaded in <span class="SpellE">WebBrowser</span> Control (<span class="SpellE">VBWebBrowserAutomation</span>)</h1>
<h2>Introduction</h2>
...
UserName</span> and Password in <span class="SpellE">StoredSites</span>\www.codeplex.com.xml with your username and password for http://www.codeplex.com first.</p>
<p class="MsoNormal">Step2. Build this project in VS2012. </p>
<p class="MsoNormal">Step3. Run VBWebBrowserAutomation.exe. The button &quot;Auto Complete&quot; is disabled by default.</p>
<p class="MsoNormal"><span style=""><img src="/site/view/file/97995/1/image.png" alt="" width="576" height="297" align="middle">
</span></p>
...
<span class="SpellE"><span class="GramE">Url</span></span> textbox and press GO.</p>
...
<span class="SpellE"><span class="GramE">url</span></span> if you login the site successfully.</p>
<p class="MsoNormal"><span style=""><img src="/site/view/file/97996/1/image.png" alt="" width="576" height="297" align="middle">
</span></p>
...
<p class="MsoNormal"><span style=""><img src="/site/view/file/97997/1/image.png" alt="" width="576" height="443" align="middle">
</span></p>
<p class="MsoNormal">Step6. After the new web page is loaded, click the button &quot;Auto Complete&quot; again, and the &quot;New email address&quot; field in the web page will be filled.</p>
<p class="MsoNormal"><span style=""><img src="/site/view/file/97998/1/image.png" alt="" width="575" height="448" align="middle">
</span></p>
...
<p class="MsoNormal"><span style=""><img src="/site/view/file/97999/1/image.png" alt="" width="576" height="276" align="middle">
</span></p>
...
FillWebPage</span> to complete the web page automatically. If a submit button could be found, then the button will also be clicked automatically.</p>
<p class="MsoNormal" style="margin-bottom:0in; margin-bottom:.0001pt; line-height:normal; text-autospace:none">
</p>
<p class="MsoNormal" style="margin-bottom:0in; margin-bottom:.0001pt; line-height:normal; text-autospace:none">
...
<span class="SpellE">deserialized</span> to a <span class="SpellE">BlockSites</span> instance.</p>
<p class="MsoNormal" style="margin-bottom:0in; margin-bottom:.0001pt; line-height:normal; text-autospace:none">
</p>
<p class="MsoNormal" style="margin-bottom:0in; margin-bottom:.0001pt; line-height:normal; text-autospace:none">

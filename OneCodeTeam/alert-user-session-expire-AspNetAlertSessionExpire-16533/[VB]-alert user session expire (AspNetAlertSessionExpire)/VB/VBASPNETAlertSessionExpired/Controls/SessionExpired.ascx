...
///\****************************************************************************
-->
<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="SessionExpired.ascx.vb" Inherits="VBASPNETAlertSessionExpired.Controls.SessionExpired" %>
...
Your session will be expired after <span id="expiredTime"></span> secondes, would you like to extend the session time?
</span>
</td>
</tr>
<tr>

========================================================================
                   VBASPNETAlertSessionExpired Overview
========================================================================
...
Open the VBASPNETAlertSessionExpired.sln with Visual Studio2010, extend the 
VBASPNETAlertSessionExpired web application node and press F5 to test the application.
...
Step 1.  Create an ASP.NET Web Application. In this sample it is 
         "VBASPNETAlertSessionExpired".

Step 2.  Right-click the VBASPNETAlertSessionExpired , and click Add -> New Item ->
         New Folder "Controls".
		 Right-click The Controls directory, and click Add-> New Item -> Web
		  User Control name as "SessionExpired.ascx":
		 * SessionExpired.ascx.vb: 
...
Step 3.  Right-click the VBASPNETAlertSessionExpired , and click Add -> New Item ->
         New Folder "Util".
...
Step 6.  Open the Web.config(If the is no Web.config, create one.)

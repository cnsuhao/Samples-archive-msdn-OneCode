...
<h1>Code syntax highlight in ASP.NET webpage (CSASPNETHighlightCodeInPage)</h1>
<h2>Introduction</h2>
<p class="MsoNormal">Sometimes we input code like C# or HTML in our post and we need these code<span style="">s t</span>o be highlighted for a better reading experience.<span style="">
...
<span style=""><img src="/site/view/file/71736/1/image.png" alt="" width="1297" height="456" align="middle">
</span></span></p>
<h2>Using the Code</h2>
<p class="MsoNormal">Step1: Create a C# ASP.NET Empty Web Application in Visual Studio 2012.<span style=""><br>
</span>Step2: Add a C# class file which named as 'CodeManager' in Visual Studio 2012.<span style="">
...
</span>CodeManager.cs file.<span style=""><br>

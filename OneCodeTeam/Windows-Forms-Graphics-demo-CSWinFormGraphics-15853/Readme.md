# Windows Forms Graphics demo (CSWinFormGraphics)
## Requires
* Visual Studio 2010
## License
* MS-LPL
...
<h1><span style="font-family:������">WINDOWS FORMS APPLICATION</span>(<span style="font-family:������">CSWinFormGraphics</span>)</h1>
<h2>Introduction</h2>
...
<p class="MsoNormal"><span style=""><img src="/site/view/file/53196/1/image.png" alt="" width="576" height="408" align="middle">

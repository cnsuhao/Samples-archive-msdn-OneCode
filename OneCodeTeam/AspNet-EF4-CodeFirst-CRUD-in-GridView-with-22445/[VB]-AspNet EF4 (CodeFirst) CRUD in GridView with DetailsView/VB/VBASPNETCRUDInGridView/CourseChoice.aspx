<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CourseChoice.aspx.vb" Inherits="VBASPNETCodeFirstCRUDInGridViewWithDetailsView.CourseChoice" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="StudentDataSource" runat="server" SelectMethod="SelectAllStudents"
             TypeName="VBASPNETCodeFirstCRUDInGridViewWithDetailsView.DBObjectDataSource"></asp:ObjectDataSource>
    </div>
    ...
    <asp:ObjectDataSource ID="Student_CourseDataSource" runat="server" SelectMethod="SelectAllCoursesByStudentId"
         TypeName="VBASPNETCodeFirstCRUDInGridViewWithDetailsView.DBObjectDataSource" DeleteMethod="DeleteCourseScore"

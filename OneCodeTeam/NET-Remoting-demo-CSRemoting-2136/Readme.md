...
<h1><span style="">.NET Remoting demo (CSRemoting) </span></h1>
<h2>Introduction</h2>
...
<p class="MsoNormal">CSRemotingSharedLibrary contains the remote object types shared by the .NET Remoting clients and servers.</p>
<p class="MsoNormal">CSRemotingClient is a .NET Remoting client project. It accesses the remote objects (SingleCall objects or Singleton objects or client-activated objects) exposed by the .NET Remoting server project, CSRemotingServer.</p>

...
<h1>Show the file upload status based on AJAX (CSASPNETFileUploadStatus)</h1>
<h2>Introduction</h2>
...
<p class="MsoNormal"><span style=""><img src="/site/view/file/84747/1/image.png" alt="" width="326" height="67" align="middle">
</span><br>
...
<p class="MsoNormal"><span style=""><img src="/site/view/file/84748/1/image.png" alt="" width="576" height="182" align="middle">
</span></p>
<h2>Using the Code</h2>
<p class="MsoNormal">Step 1.<span style="">&nbsp; </span>Create a C# &quot;Class Library&quot; Project in Visual Studio 2012 or Visual Web Developer 2012. Name it as &quot;FileUploadStatus.&quot;<br>
<br>
Step 2.<span style="">&nbsp; </span>Add the two references into the project, <b style="">
System.Web.Extension</b> and <b style="">System.Web</b>.</p>
<p class="MsoNormal">Step 3.<span style="">&nbsp; </span>Copy the code from the UploadStatus.cs from the sample folder, &quot;FileUploadStatus&quot;.</p>

...
<%@ Page Language="VB" AutoEventWireup="true" CodeBehind="EditSiteProperty.aspx.vb" Inherits="VBSharePointRefreshParentPage.Layouts.CloseModalDialogRefreshParentPage.EditSiteProperty" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="PageTitle" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    <SharePoint:EncodedLiteral ID="EncodedLiteral1" runat="server" Text="Edit Site Property" EncodeMethod='HtmlEncode' />
</asp:Content>

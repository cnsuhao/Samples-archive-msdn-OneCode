...
<%@ Page Language="VB" AutoEventWireup="true" CodeBehind="AddSiteProperty.aspx.vb" Inherits="VBSharePointRefreshParentPage.Layouts.CloseModalDialogRefreshParentPage.AddSiteProperty" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="PageTitle" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    <SharePoint:EncodedLiteral ID="EncodedLiteral1" runat="server" text="Add Site Property" EncodeMethod='HtmlEncode'/>
</asp:Content>

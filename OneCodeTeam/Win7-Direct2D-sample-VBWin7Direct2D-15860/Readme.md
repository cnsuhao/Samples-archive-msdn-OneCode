# Win7 Direct2D sample (VBWin7Direct2D)
## Requires
* Visual Studio 2010
## License
* MS-LPL
...
<p class="MsoNormal"><span style=""><img src="/site/view/file/53243/1/image.png" alt="" width="989" height="566" align="middle">
</span></p>
...
<p class="MsoListParagraphCxSpMiddle" style=""><span style="font-family:Symbol"><span style="">��<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span>Create a PowerShell script to translate XAML path data to <span style="">
VB.NET</span> Direct2D code.</p>
<p class="MsoListParagraphCxSpMiddle" style=""><span style="font-family:Symbol"><span style="">��<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<p class="MsoNormal"><span style=""><img src="/site/view/file/53244/1/image.png" alt="" width="989" height="566" align="middle">
...
<p class="MsoNormal" style="margin-left:35.45pt">To work with Direct2D, you can either manually write a managed wrapper, or take advantage of the<span style="">
</span><a href="http://code.msdn.microsoft.com/WindowsAPICodePack/Release/ProjectReleases.aspx?ReleaseId=3077"><b style=""><span style="">Windows API Code Pack</span></b></a> (recommended). The Windows API Code Pack exposes most (while not all) of the new Windows
 7 and Direct 3D 10/11 features to managed code. It should be sufficient in most scenarios.<span style="">
</span></p>
<p class="MsoNormal" style="margin-left:35.45pt">Note since the DirectX part in the code pack is written in managed C&#43;&#43;, targeting x86, your managed application will have to target x86 as well (rather than Any CPU) if you're running on a 64 bit OS. Alternatively,
 you can recompile the code pack targeting x64. This is required if you want to use the code pack in a 64 bit only environment, such as Windows Azure. This sample will target x86 only.<span style="">
</span></p>
<p class="MsoNormal" style="margin-left:35.45pt">If you encounter a limitation, you can easily expose the missing feature by modifying the source code. For example, the D3DX10CreateEffectFromFile function in Direct3D, which allows you to load an HLSL file

...
<pre><div class="scriptcode"><div class="pluginEditHolder" pluginCommand="mceScriptCode"><div class="title"><span>C#</span></div><div class="pluginLinkHolder"><span class="pluginEditHolderLink">Edit</span>|<span class="pluginRemoveHolderLink">Remove</span></div><span class="hidden">csharp</span><pre class="hidden">private static readonly StorageCredentials cred = new StorageCredentials(&quot;[Your storage account name]&quot;, &quot;[Your storage account key]&quot;);
public static readonly CloudBlobContainer container = new CloudBlobContainer(new Uri(&quot;http://[Your storage account name].blob.core.windows.net/imagescontainer/&quot;), cred);
 </pre>
<div class="preview">

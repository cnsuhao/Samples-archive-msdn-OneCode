...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ModalDialog.ascx.cs"
    Inherits="CSSharePointRefreshParentPage.ModalDialogWebPart.ModalDialogWebPartUserControl" %>
        ...
        <SharePoint:SPGridView runat="server" ID="SitePropertiesGridView" Width="100%" AutoGenerateColumns="false"
            ...
            <Columns>
                <asp:TemplateField HeaderText="Property Name" HeaderStyle-Width="30%" HeaderStyle-CssClass="ms-vh2-nofilter">
                    <ItemTemplate>
                        <a href="#" onclick="openSitePropertyDialog('<%# GetEditSitePropertyUrl(SPHttpUtility.UrlKeyValueEncode((string)DataBinder.Eval(Container.DataItem, "Name"))) %>');return false;">
                            <%# SPHttpUtility.HtmlEncode((string)DataBinder.Eval(Container.DataItem, "Name")) %></a>
                    </ItemTemplate>
                </asp:TemplateField>

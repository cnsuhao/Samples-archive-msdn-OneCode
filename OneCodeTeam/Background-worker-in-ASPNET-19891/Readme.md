# Background worker thread in ASP.NET (VBASPNETBackgroundWorker)
## Requires
* Visual Studio 2012
## License
* MS-LPL
...
<h1>Background worker thread in ASP.NET (<span class="SpellE">VBASPNETBackgroundWorker</span>)</h1>
<h2>Introduction</h2>
...
</span></span></span>Open the VBASPNETBackgroundWorker.sln.<span style=""> </span>
</p>
...
</span></span></span>Expand the <span class="SpellE">VBASPNETBackgroundWorker</span> web application and press Ctrl &#43; F5 to show the Default.aspx.</p>
...
<img src="/site/view/file/72283/1/image.png" alt="" width="784" height="320" align="middle">
</span><br>

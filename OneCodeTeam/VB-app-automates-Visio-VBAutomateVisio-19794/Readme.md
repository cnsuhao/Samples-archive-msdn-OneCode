...
<h2>Introduction</h2>
<p class="MsoNormal">The <span style="">VB</span>AutomateVisio provides the examples on how to automate Office Visio 2010 via Visio Object Model.
<span style=""></span></p>
...
<span style="">Visio</span> application by using Microsoft <span style="">Visio</span> PIA and forcing a garbage collection as soon as the automation function is off the stack (at which point the RCW objects are no longer rooted) to clean up RCWs and release
 COM objects<span style="">&lt;o:p&gt;.&lt;/o:p&gt;</span></p>
<h2>Running the Sample</h2>
<p class="MsoNormal">You must run this code <span style="">on a computer that has Microsoft Office Visio2010 installed.
</span></p>
<p class="MsoNormal"><span style=""><img src="/site/view/file/71849/1/image.png" alt="" width="490" height="328" align="middle">

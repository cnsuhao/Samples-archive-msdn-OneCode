...
<h1>How to create an irregularly shaped windows for WPF UI (VBWPFIrregularShapeWindow)</h1>
<h2>Introduction</h2>
...
<p class="MsoNormal">Step2. Using PNG format image files replace the images' list of transparentPic. PNG formats.</p>
...
<p class="MsoNormal">Step2. We can use ScaleTransform to enlarge and reduce the size of objects. And these are two opposite actions, so when different commands are in effect the objects are light or dark.</p>
<p class="MsoNormal">Step3. If you use a menu item to influence an object, you should set examples from the menu item, Commandtarget method and button, otherwise menu item object will be invalid.</p>
<p class="MsoNormal">Step4. This sample provides a ready-made examples of ways to judge whether the CommandBinding object such as canExecute method to receive results which are true or false.</p>

# Navigation usage in WPF (VBWPFNavigationUsage)
## Requires
* Visual Studio 2008
## License
* MS-LPL
...
<h1><span style="">Navigation usage in WPF (VBWPFNavigationUsage) </span></h1>
<h2>Introduction</h2>
<p class="MsoNormal"><br>
The sample demonstrates how to page data in WPF.<span style="">� </span>Method NavigationService.Navigate() is used to navigate to another page. The parameter needed is often an Uri, and can also be any custom classes.<span style="">
</span></p>
<h2>Running the Sample<span style=""> </span></h2>
<p class="MsoNormal"><span style="">Press F5 to run this application, you will see following result.
</span></p>
<p class="MsoNormal"><span style=""><img src="/site/view/file/54098/1/image.png" alt="" width="769" height="575" align="middle">

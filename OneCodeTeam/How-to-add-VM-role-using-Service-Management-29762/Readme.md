...
<h1>How to add VM role using Service Management libraries</h1>
<h2>Introduction</h2>
<p>There are two methods in Service Management REST API to create Azure Virtual Machine.</p>
<p>The first is <a href="http://msdn.microsoft.com/en-us/library/jj157194.aspx">Create Virtual Machine Deployment</a>, and the second is
<a href="http://msdn.microsoft.com/en-us/library/jj157186.aspx">Add Role</a>.</p>
<p>This code snippet will show how to work with these methods by using the latest
<a href="http://www.nuget.org/packages/Microsoft.WindowsAzure.Management.Libraries">
Service Management libraries</a>.</p>
<p>For both methods, you need to create a hosted service first.</p>
<h2>Using the Code</h2>
<p>The following code shows how to create a hosted service for Azure VM.</p>
<h2>

# C++ named-pipe server for IPC (CppNamedPipeServer)
## Requires
* Visual Studio 2008
## License
...
<h2>CONSOLE APPLICATION : CppNamedPipeServer Project Overview</h2>
<p style="font-family:Courier New">&nbsp;</p>
<h3>Summary:</h3>
...
<br>
This code sample demonstrates calling CreateNamedPipe to create a pipe <br>
named &quot;\\.\pipe\SamplePipe&quot;, which supports duplex connections so that both <br>
client and server can read from and write to the pipe. The security <br>
...
<br>
Step1. After you successfully build the CppNamedPipeClient and <br>
CppNamedPipeServer sample projects in Visual Studio 2008, you will get the <br>
applications: CppNamedPipeClient.exe and CppNamedPipeServer.exe. <br>
<br>
Step2. Run CppNamedPipeServer.exe in a command prompt to start up the server <br>
end of the named pipe. The application will output the following information <br>

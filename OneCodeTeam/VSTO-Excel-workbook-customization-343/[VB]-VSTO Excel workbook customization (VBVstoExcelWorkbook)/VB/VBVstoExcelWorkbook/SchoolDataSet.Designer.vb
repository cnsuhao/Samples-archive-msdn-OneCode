...
Partial Public Class SchoolDataSet
    ...
    Partial Public Class StudentListDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddStudentListRow(ByVal StuName As String, ByVal PersonCategory As Short, ByVal EnrollmentDate As Date) As StudentListRow
            Dim rowStudentListRow As StudentListRow = CType(Me.NewRow,StudentListRow)
            Dim columnValuesArray() As Object = New Object() {StuName, PersonCategory, EnrollmentDate}
...
Namespace SchoolDataSetTableAdapters
    ...
    Partial Public Class StudentListTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT     FirstName + ' ' + LastName AS StuName, PersonCategory, EnrollmentDate"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Person"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (PersonCategory = 1)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class CourseListTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT     CourseStuGradeDeptView.CourseTitle AS Title, CourseStuGradeDeptView.Co"& _ 
                "urseCredits AS Credits, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      CourseStuGradeDeptView.DeptName "& _ 
                "AS Department, CourseInstructorView.InstructorName AS Instructor"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         C"& _ 
                "ourseInstructorView INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      CourseStuGradeDeptView ON "& _ 
                "CourseInstructorView.CourseID = CourseStuGradeDeptView.CourseID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (Cour"& _ 
                "seStuGradeDeptView.StuName = @stuName)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text

...
NotInheritable Class App
    ...
    Public Shared credentials As New StorageCredentials("{Account-Key}", "{Account-Value}")
    Public Shared account As New CloudStorageAccount(credentials, False)
    Public Shared tableName As String = "pictures", contianerName As String = "pictures"

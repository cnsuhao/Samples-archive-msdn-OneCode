...
<h2>Introduction</h2>
<p class="MsoNormal">ATLCOMClient shows you how to call COM server objects in ATL and implement an event sink using the ATL IDispEventImpl and IDispEventSimpleImpl classes for events in the COM server.
</p>
...
<p class="MsoNormal"><span style=""><img src="/site/view/file/53753/1/image.png" alt="" width="713" height="330" align="middle">
</span></p>
<h2>Using the Code</h2>
<p class="MsoNormal">Step1. Create a C&#43;&#43; Win32 console project in Visual Studio 2008, and add common header files for ATL.
</p>

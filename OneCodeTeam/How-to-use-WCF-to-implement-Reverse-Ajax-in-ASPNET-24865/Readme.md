...
<h1>Use WCF to implement Reverse Ajax (VBWCFReverseAJAX)</h1>
<h2>Introduction</h2>
...
<p class="MsoNormal">Step 1: Open the VBWCFReverseAJAX.sln.<br>
...
<p class="MsoNormal"><span style=""><img src="/site/view/file/96048/1/image.png" alt="" width="575" height="253" align="middle">
</span><br>
...
<p class="MsoListParagraphCxSpMiddle"><span style="">&nbsp;</span>Also the server can send a message to the client. The class contains two private members and two public methods.</p>

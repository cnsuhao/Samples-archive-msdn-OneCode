...
{
    partial class GetWrapperRibbon : Microsoft.Office.Tools.Ribbon.RibbonBase
    {
        /// <summary>
        ...
        {
            this.tabCfx = this.Factory.CreateRibbonTab();
            this.grpGetWrapperObject = this.Factory.CreateRibbonGroup();
            this.btnShowGetWrapperCS = this.Factory.CreateRibbonButton();
            ...
            this.btnShowGetWrapperCS.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.btnShowGetWrapperCS_Click);
            // 
            // GetWrapperRibbon
            // 
            ...
            this.Load += new Microsoft.Office.Tools.Ribbon.RibbonUIEventHandler(this.GetWrapperRibbon_Load);

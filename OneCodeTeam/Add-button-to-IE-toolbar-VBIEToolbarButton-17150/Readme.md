# Add button to  IE toolbar (VBIEToolbarButton)
## Requires
* Visual Studio 2010
## License
* MS-LPL
...
## Description
================================================================================<br>
&nbsp; &nbsp; &nbsp; Windows APPLICATION: VBIEToolbarButton Overview &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br>
===============================================================================<br>
/////////////////////////////////////////////////////////////////////////////<br>
Summary:<br>
...
<br>
Navigate to the folder that contains the build result VBIEToolbarButton.dll and <br>
enter the command:<br>
<br>
&nbsp; &nbsp;Regasm.exe VBIEToolbarButton.dll /codebase<br>
<br>
...
enter the command:<br>
<br>
&nbsp; &nbsp;Regasm.exe VBIEToolbarButton.dll /unregister<br>
<br>
...
A. Setup<br>
<br>
For 32bit IE on x86 or x64 OS, install VBIEToolbarButtonSetup(x86).msi, the output<br>
of the VBIEToolbarButtonSetup(x86) setup project.<br>
<br>
For 64bit IE on x64 OS, install VBIEToolbarButtonSetup(x64).msi outputted by the <br>
VBIEToolbarButtonSetup(x64) setup project.<br>
<br>
B. Removal<br>
<br>
For 32bit IE on x86 or x64 OS, uninstall VBIEToolbarButtonSetup(x86).msi, the <br>
output of the VBIEToolbarButtonSetup(x86) setup project. <br>
<br>
For 64bit IE on x64 OS, uninstall VBIEToolbarButtonSetup(x64).msi, the output of<br>
the VBIEToolbarButtonSetup(x64) setup project.<br>
<br>
<br>
<br>
////////////////////////////////////////////////////////////////////////////////<br>
...
&nbsp; &nbsp; &nbsp; sure that the projects VBIEToolbarButton and VBIEToolbarButtonSetup(x86)<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; select VBIEToolbarButton and VBIEToolbarButtonSetup(x64) to build.<br>
&nbsp; &nbsp; &nbsp; &nbsp;<br>
Step2. Build the solution.<br>
<br>
Step3. Right click the project VBIEToolbarButtonSetup(x86) in Solution Explorer, <br>
...
<br>
The NotePadToolbarButton.vb file defines the Toolbar button. <br>
<br>
...
&nbsp;VBIEToolbarButtonSetup(x86). Click OK to create the project. <br>
...
&nbsp;In the Add Project Output Group dialog box, VBIEToolbarButton will &nbsp;<br>
&nbsp;be displayed in the Project list. Select Primary Output and click OK. VS<br>
&nbsp;will detect the dependencies of the VBIEToolbarButton, including .NET<br>
...
<br>
&nbsp;VBIEToolbarButton. This adds the custom actions that we defined <br>
&nbsp;in BHOInstaller of VBIEToolbarButton. <br>
<br>
...
<br>
&nbsp;must create a new setup project (e.g. VBIEToolbarButtonSetup(x64) <br>
...
&nbsp;file in the VBIEToolbarButtonSetup(x64) project folder. To <br>
&nbsp;configure the script to run in the post-build event, you select the <br>
&nbsp;VBIEToolbarButtonSetup(x64) project in Solution Explorer, and <br>

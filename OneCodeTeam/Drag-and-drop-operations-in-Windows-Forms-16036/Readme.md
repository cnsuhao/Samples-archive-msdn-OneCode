...
<p class="MsoNormal"><span style=""><img src="/site/view/file/54144/1/image.png" alt="" width="720" height="483" align="middle">
</span><span style=""></span></p>
<p class="MsoNormal"><span style="">The items are added into the <span class="SpellE">
TreeView</span> control. </span></p>
<p class="MsoNormal"><span style=""><img src="/site/view/file/54145/1/image.png" alt="" width="720" height="483" align="middle">
</span><span style=""></span></p>
...
<p class="MsoNormal"><span style="">4. Handle the DragDrop event on the destination control to retrieve the data dragged from the source control.
</span></p>
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
<div class="title"><span>C#</span></div>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Home.aspx.vb" Inherits="VBAzureMultiUploadDownloadBlobStorage.Home" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>download /upload multiple files from/to in Windows Azure blob storage</title>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Panel ID="pnl_BlobList" runat="server" EnableViewState="true">
                <asp:Label ID="lbl_BlobError" runat="server" Height="200px" ForeColor="Red" Visible="false"> There is no any blob </asp:Label>
                <br />

# Load Controls in ASP.NET Embedded Resources (VBASPNETAccessResourceInAssembly)
## Requires
* Visual Studio 2008
## License
* MS-LPL
...
<p class="MsoNormal">Step 2: We will see two user controls and two links on the web page, the red border part of the page is come from VBASPNETAssembly project, so as the link below. The blue border part of the page and the ��WebSite/WebPage�� link are come
 from this project.</p>
<p class="MsoNormal"><span style=""><span style="">&nbsp;</span> <img src="/site/view/file/59696/1/image.png" alt="" width="537" height="374" align="middle">
</span></p>
...
<p class="MsoNormal"><span style=""><img src="/site/view/file/59697/1/image.png" alt="" width="537" height="374" align="middle">
</span></p>
<p class="MsoNormal">The page comes from this project:</p>
<p class="MsoNormal"><span style=""><img src="/site/view/file/59698/1/image.png" alt="" width="537" height="374" align="middle">
</span></p>

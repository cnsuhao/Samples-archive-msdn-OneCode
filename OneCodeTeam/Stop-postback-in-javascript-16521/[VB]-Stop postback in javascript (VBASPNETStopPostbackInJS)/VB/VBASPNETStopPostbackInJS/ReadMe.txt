...
Step 1: Open the VBASPNETStopPostbackInJS.sln.

Step 2: Expand the VBASPNETStopPostbackInJS web application and press 
...
Step 1. Create a VB "ASP.NET Empty Web Application" in Visual Studio 2010 or
        Visual Web Developer 2010. Name it as "VBASPNETStopPostbackInJS".

Step 2. Add three web forms in the root directory, name them as "Dafault.aspx", 

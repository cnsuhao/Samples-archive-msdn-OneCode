...
<fieldset>
    ...
    <asp:Repeater ID="Repeater1" runat="server" 
        ...
        <ItemTemplate>
            <tr style="width:100%">
                <td style="width:25%">
                    FieldName:(Type of <%#(Container.DataItem as Structure).DataType%>)
                    <br />
                    <asp:DropDownList ID="ddrFields" AutoPostBack="true" runat="server" Width="50%" DataSource='<%#(Container.DataItem as Structure).ColumnNames %>' OnSelectedIndexChanged="ddrColumnNames_SelectedIndexChanged">
                    </asp:DropDownList>
                    </td>
                <td style="width:25%">
                    Condition:
                    <br />
                    <asp:DropDownList ID="ddrOperation" Width="50%" DataSource='<%#(Container.DataItem as Structure).Operations %>'
                     runat="server" >
                    </asp:DropDownList>
                </td>
                 <td style="width:25%">
                ...
                <td style="width:25%">
                   Relation:
                   <br />
                   <asp:DropDownList ID="ddrRelation" runat="server" Width="50%"  DataSource='<%#(Container.DataItem as Structure).Relations %>'>
                    </asp:DropDownList>
                </td>
                <td style="width:20%">

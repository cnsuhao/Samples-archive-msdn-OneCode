# VB app uses ADO.NET to access database (VBUseADONET)
## Requires
* Visual Studio 2008
## License
* MS-LPL
...
<h2>CONSOLE APPLICATION : VBUseADONET Project Overview</h2>
<p style="font-family:Courier New">&nbsp;</p>
<h3>Use:</h3>
<p style="font-family:Courier New"><br>
The VBUseADONET example demonstrates the Microsoft ADO.NET technology to <br>
access databases using Visual Basic. It shows the basic structure of <br>
...
<p style="font-family:Courier New"><br>
VBUseADONET -&gt; SQLServer2005DB<br>
VBUseADONET accesses the database created by SQLServer2005DB.<br>
<br>
</p>
<h3>Code Logic:</h3>
<p style="font-family:Courier New"><br>

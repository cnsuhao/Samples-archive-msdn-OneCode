# Alert user session expire (CSASPNETAlertSessionExpire)
## Requires
* Visual Studio 2012
## License
* MS-LPL
...
<h1>How to show alert to user when their session is about to expire (CSASPNETAlertSessionExpired)</h1>
<h2>Introduction</h2>
...
</span></span></span>Open the CSASPNETAlertSessionExpired.sln.<span style=""> </span>
</p>
...
</span></span></span>Expand the CSASPNETAlertSessionExpired web application and press Ctrl &#43; F5 to show the Default.aspx.</p>
...
<p class="MsoListParagraphCxSpMiddle" style="margin-left:.25in"><span style=""><img src="/site/view/file/71711/1/image.png" alt="" width="310" height="130" align="middle">
</span></p>
...
<p class="MsoListParagraphCxSpMiddle" style="margin-left:.25in"><span style=""><img src="/site/view/file/71712/1/image.png" alt="" width="524" height="187" align="middle">
</span></p>

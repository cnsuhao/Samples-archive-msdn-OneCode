'****************************** Module Header ******************************\
' Project Name:   VBAzureServiceBusProtocolBridging
...
Module Program
    ...
    Sub Main()
        ...
        Dim tokenProvider As TokenProvider = tokenProvider.CreateSharedSecretTokenProvider(Settings.IssuerName, Settings.IssuerSecret)

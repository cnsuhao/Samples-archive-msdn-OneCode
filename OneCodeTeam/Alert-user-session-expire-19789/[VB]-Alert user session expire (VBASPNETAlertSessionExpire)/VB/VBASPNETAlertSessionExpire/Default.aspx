<%@ Page Title="Alert Session is about to expired" Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true"
	CodeBehind="Default.aspx.vb" Inherits="VBASPNETAlertSessionExpired._Default" %>

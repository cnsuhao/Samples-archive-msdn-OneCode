<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CSASPNETExcelLikeGridView._Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CSASPNETExcelLikeGridView</title>
    ...
    <script type="text/javascript">
        ...
        function ResetColors(color1, color2) {         
            var contents = document.getElementById("<%=HidState.ClientID %>").value;
...
<body>
    <form id="form1" runat="server">
        <h1>Demo for Batching Actions</h1>

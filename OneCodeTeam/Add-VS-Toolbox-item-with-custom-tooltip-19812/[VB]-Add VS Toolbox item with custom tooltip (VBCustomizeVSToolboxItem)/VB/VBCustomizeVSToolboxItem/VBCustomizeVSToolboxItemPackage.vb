' Implementation of VBCustomizeVSToolboxItem
'
...
ProvideLoadKey("Standard", "1.0", "VBCustomizeVSToolboxItem", "Microsoft", 1), _
...
#Region "Package Members"
    ...
    Private Function VerifyToolboxItemExist() As Boolean
        ...
        Dim rgelt As Microsoft.VisualStudio.OLE.Interop.IDataObject() = New Microsoft.VisualStudio.OLE.Interop.IDataObject(0) {}
        Dim i As Integer = items.Next(1, rgelt, num)
        Do While (ErrorHandler.Succeeded(i) AndAlso (num > 0)) AndAlso (rgelt(0) IsNot Nothing)
            Dim displayName As String = Nothing

            Dim hr As Integer = (TryCast(vsToolbox2, IVsToolbox3)).GetItemDisplayName(rgelt(0), displayName)
            ErrorHandler.ThrowOnFailure(hr)
    ...
    Private Sub AddToolboxItem()
        ...
        Dim toolboxData As Microsoft.VisualStudio.Shell.OleDataObject = New Microsoft.VisualStudio.Shell.OleDataObject()

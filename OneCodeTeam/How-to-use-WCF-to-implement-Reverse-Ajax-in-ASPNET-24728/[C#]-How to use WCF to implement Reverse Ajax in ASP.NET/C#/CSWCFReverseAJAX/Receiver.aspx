<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Receiver.aspx.cs" Inherits="CSWCFReverseAJAX.Receiver" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="2147483647">
            <Services>
                <asp:ServiceReference Path="Dispatcher.svc" />
            </Services>
        </asp:ScriptManager>
        ...
        <script type="text/javascript">
            ...
            function waitEvent() {
                ...
                Dispatcher.WaitMessage("<%= Session["userName"] %>",
   function (result) {

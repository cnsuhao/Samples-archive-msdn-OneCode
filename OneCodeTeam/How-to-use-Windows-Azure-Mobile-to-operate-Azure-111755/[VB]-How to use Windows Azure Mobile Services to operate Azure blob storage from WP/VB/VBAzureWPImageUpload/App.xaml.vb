...
Partial Public Class App
    ...
    Private Shared m_mobileService As New MobileServiceClient("https://DinoUploadImage.azure-mobile.net/", "GtnWLGGCvAyATPvFRunnUqBqwSRlQf15")
    Public Shared ReadOnly Property MobileService() As MobileServiceClient
        Get
